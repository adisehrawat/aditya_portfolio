  ...
  return (
    ...
    >
      ...
      <FadeInSection delay="0.5s">
        <h2 className="xl:text-5xl sm:text-2xl md:text-3xl text-xl xl:mt-10 md:mt-8 sm:mt-5 mt-2">Who are You ?</h2>
      </FadeInSection>

      <FadeInSection delay="0.8s">
        <p className="max-w-3xl mt-4 xl:text-2.5xl md:text-1.5xl sm:text-xl text-gray-300 px-4 sm:px-2">
